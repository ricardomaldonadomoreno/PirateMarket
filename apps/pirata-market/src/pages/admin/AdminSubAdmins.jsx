...
// AdminSubAdmins — Crear y administrar sub-administradores
// - Solo super_admin (scope='all') puede acceder
// - Sub-admins: scope='pirata' | 'traficante' | 'both'
// - Crear via Edge Function `create-admin` (slug: rapid-handler)
// - Listar/eliminar/activar via tabla admins
...
export default function AdminSubAdmins() {
  ...
  const checkAuth = () => {
    ...
    // Solo super_admin puede administrar sub-admins
    if (scope !== 'all') {
  ...
  const scopeLabel = (scope) => {
    const map = { pirata: 'Pirata', traficante: 'Packer', both: 'Ambas', all: 'SuperAdmin' }
    ...
    <div className="admin-page">
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '3rem 2rem' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <Link to="/admin/home" style={{ textDecoration: 'none', fontSize: '0.85rem', color: 'var(--text-muted)' }}>
            ← Volver al Dashboard
          </Link>
          <h1 className="serif luxury-gold" style={{ fontSize: '1.8rem', marginTop: '0.5rem' }}>Sub-Administradores</h1>
        ...
        <div className="admin-card" style={{ marginBottom: '2rem' }}>
          <h3 className="serif" style={{ color: 'var(--gold)', marginBottom: '0.5rem', fontSize: '1.1rem' }}>Crear Sub-Admin</h3>
